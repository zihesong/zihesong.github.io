...
title: about
permalink: /
subtitle: PhD Candidate in Computer Science at UT Dallas · Research on LLMs, UI testing, and intelligent interaction
...
I build **LLM-driven agents** and **automation frameworks** that can understand and interact with complex user interfaces:
they explore apps, reason about ambiguous user goals, and generate robust test executions at scale. My work combines
program analysis, UI modeling, and multimodal interaction to make intelligent systems more **reliable, efficient, and usable**.
